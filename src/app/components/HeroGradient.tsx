...
export function HeroGradient() {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      // Mobile: batasi area ribbon hanya sampai tombol CTA (~48% height),
      // biarkan sisa bawah tetap bersih (area mockup)
      ...
      // Mobile: stretch koordinat-x dari titik tengah supaya ribbon lebih miring
      // (diagonal tengah-atas → kanan-bawah), bukan tegak
      ...
      /* ── White fade overlay (dalam clip region) ── */
      if (!isMobile) {
        ...
        /* Mobile: fade putih dari kiri, biarkan kanan-atas tetap berwarna */
      ...
      // Bottom fade: mulai dari 65% drawH → habis di drawH (ujung clip area)
