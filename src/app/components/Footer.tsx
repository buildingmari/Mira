      ...
      <div className="footer-main">
        ...
        <div className="footer-brand">
          ...
          <div className="footer-social">
            <a href="https://wa.me/6281234567890" target="_blank" rel="noopener noreferrer" className="footer-social-btn" aria-label="WhatsApp">
            ...
            <a href="https://tiktok.com/@getmira.id" target="_blank" rel="noopener noreferrer" className="footer-social-btn" aria-label="TikTok">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.28 6.28 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.69a8.18 8.18 0 004.79 1.53V6.79a4.85 4.85 0 01-1.02-.1z"/></svg>
            </a>
          </div>
        </div>
        ...
        <div className="footer-col">
          ...
          <ul className="footer-col-links">
            ...
            <li><a href="#preview">Lihat Dashboard</a></li>
        ...
        <div className="footer-col">
          ...
          <div className="footer-contact-list">
            <div className="footer-contact-item">
              ...
              <a href="https://wa.me/6281234567890" target="_blank" rel="noopener noreferrer" className="footer-contact-val">+62 812-3456-7890</a>
            </div>
            <div className="footer-contact-item">
              <div className="footer-contact-label">Email</div>
              <a href="mailto:hi@getmira.id" className="footer-contact-val">hi@getmira.id</a>
            </div>
            <div className="footer-contact-item">
              <div className="footer-contact-label">Jam Operasional</div>
              <div className="footer-contact-val">MIRA aktif 24/7</div>
            </div>
          </div>
        </div>
      </div>
