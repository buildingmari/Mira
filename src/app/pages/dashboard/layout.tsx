...
export function DashboardLayout() {
  ...
  useEffect(() => {
    ...
    return () => { document.getElementById('mira-layout-css')?.remove(); };
  }, []);
      ...
      <PendingAssessmentGate
        ...
        onComplete={() => {
          try {
            ...
            if (r) { const c=JSON.parse(r); c.account_status='active'; sessionStorage.setItem('mira_user',JSON.stringify(c)); }
          } catch {}
